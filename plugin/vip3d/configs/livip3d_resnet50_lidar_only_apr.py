...
model = dict(
    ...
    # APR: appearance-guided past motion refinement (MASAR-inspired). Verifies a
    # continuing track's recent past against buffered LiDAR BEV evidence before the
    # LiDAR/SMCA decoder layers run this frame. history_len=2 matches what's actually
    # exercisable during training given 3-frame clips (num_frames_per_sample below).
    apr_cfg=dict(
        num_hypotheses=3,
        history_len=2,
        bev_in_channels=384,
